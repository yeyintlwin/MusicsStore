...
public abstract class GenericTag extends AbstractTag {
    private static List<FieldKey> supportedKeys;

    static {
        supportedKeys = new ArrayList<>();//EnumSet.of(FieldKey.ALBUM,FieldKey.ARTIST,FieldKey.TITLE,FieldKey.TRACK,FieldKey.GENRE,FieldKey.COMMENT,FieldKey.YEAR);
        supportedKeys.add(FieldKey.ALBUM);
        supportedKeys.add(FieldKey.ARTIST);
        supportedKeys.add(FieldKey.TITLE);
        supportedKeys.add(FieldKey.TRACK);
        supportedKeys.add(FieldKey.GENRE);
        supportedKeys.add(FieldKey.COMMENT);
        supportedKeys.add(FieldKey.YEAR);
    }
