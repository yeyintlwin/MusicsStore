...
public enum MusicalKey {
    ...
    static {
        List<MusicalKey> groundKey = new ArrayList<>();// EnumSet.of(NOTE_A, NOTE_B, NOTE_C, NOTE_D, NOTE_E, NOTE_F, NOTE_G);
        groundKey.add(NOTE_A);
        groundKey.add(NOTE_B);
        groundKey.add(NOTE_C);
        groundKey.add(NOTE_D);
        groundKey.add(NOTE_E);
        groundKey.add(NOTE_F);
        groundKey.add(NOTE_G);
